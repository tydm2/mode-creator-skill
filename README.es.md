...
## Novedades de la v1.2.0 (2026-09-06)

- **Puerta de confirmación inicial**: si el id del modo ya existe, el agente debe preguntar *sobrescribir / renombrar / reutilizar* - nada se escribe sin tu confirmación
- **Activable desde cualquier plataforma** mediante archivos de comando (el objetivo sigue siendo el directorio local de presets DSH)
- **Frontmatter conforme al estándar abierto**: metadatos planos, campo `license`, changelog en el `CHANGELOG.md` raíz
