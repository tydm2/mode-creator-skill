...
## Novidades da v1.2.0 (2026-09-06)

- **Portão de confirmação inicial**: se o id do modo já existir, o agente deve perguntar *sobrescrever / renomear / reutilizar* - nada é escrito sem sua confirmação
- **Acionável de qualquer plataforma** via arquivos de comando (o alvo continua sendo o diretório local de presets DSH)
- **Frontmatter em conformidade com o padrão aberto**: metadados planos, campo `license`, changelog no `CHANGELOG.md` raiz
